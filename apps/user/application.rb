...
module User
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['USER_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load User::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time User::Action is included
      ...
      # Configure the code that will yield each time User::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include User::Assets::Helpers
      end
    end
