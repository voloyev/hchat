...
module Room
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['ROOM_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Room::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Room::Action is included
      ...
      # Configure the code that will yield each time Room::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Room::Assets::Helpers
      end
    end
